...
const Popular = () => {
    ...
    return (
        <div className="bg-[#1F1F1F] text-white flex flex-col justify-center pb-4 pt-10 sm:pt-[80px] px-4 sm:px-[60px]">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                {popularProducts.slice(0, visibleCount).map((product) => (
                    <div key={product.code} className="flex items-center bg-animated border-2 border-[#1A1A1A] p-2 rounded-xl cursor-pointer hover:border-[#333333]">
